                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body" style="display: block;">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <button type="button" class="btn btn-success ml-3" data-toggle="modal" data-target="#modal-create">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="nombre_proveedor_modal" class="form-control">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" id="celular_modal" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" id="telefono_modal" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="">Empresa <b>*</b></label>
                                                                    <input type="text" id="empresa_modal" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="" id="direccion_modal" cols="30" rows="3" class="form-control"></textarea>
...
<script>
    ...
    $('#btn_create').click(function() {
        ...
        var nombre_proveedor = $('#nombre_proveedor_modal').val();
        var celular = $('#celular_modal').val();
        var telefono = $('#telefono_modal').val();
        var empresa = $('#empresa_modal').val();
        var email = $('#email_modal').val();
        var direccion = $('#direccion_modal').val();

        if (nombre_proveedor == "" || celular == "" || empresa == "" || direccion == "") {
